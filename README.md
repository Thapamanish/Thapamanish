...
# <img src="https://raw.githubusercontent.com/MartinHeinz/MartinHeinz/master/wave.gif" width="40px"> there, I'm <Strong> Manish Thapa </Strong> !!!
🔭 Working on optimizing 🎯Target's  Enterprise carts and checkout with Kotlin Micronaut, Kafka, Cassandra, and PostgreSQL.<br>
👯 Seeking collaboration on improving real-time order processing and scalability in e-commerce.<br>
🤝 Need help with fine-tuning database handling, Kafka event streaming, and advanced coroutine usage.<br>
🌱 Currently learning advanced Kafka optimization, enhanced coroutine usage, and database performance tuning.<br>
💬 Ask me about Kotlin/Micronaut, Kafka event-driven systems, coroutines, or database optimization.<br>
